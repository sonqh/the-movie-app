...
const MovieListItem = ({ movie }) => {
  ...
  return (
    ...
    >
      <List.Item
        className="flex items-start hover:bg-gray-200 transition-colors duration-100"
      ...
      >
        <motion.img
          ...
          alt={movie.title}
          className="w-48 h-64 object-cover mr-4 rounded-lg"
        ...
        >
          ...
          <motion.div variants={textVariants}>
            <Text className="text-gray-500 text-sm">{movie.overview}</Text>
          </motion.div>
          <motion.div
